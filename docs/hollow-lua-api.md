...
- Audience: Lua config authors, widget authors, and integrators
- Main namespaces: `hollow.config`, `hollow.term`, `hollow.events`, `hollow.keymap`, `hollow.ui`, `hollow.htp`
- Companion reference: `../types/hollow.lua`

## Use This Page To

- inspect the current runtime API surface
- understand which namespaces are stable enough to use today
- connect config, widgets, and shell integration back to the host APIs
