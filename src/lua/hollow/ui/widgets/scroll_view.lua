...
---@return integer start_idx, integer end_idx, boolean show_scrollbar, integer thumb_index
function ScrollState:update(items, cursor, row_budget)
  ...
  local row_fn = self.row_count_fn or function() return 1 end
  ...
  return start_idx, end_idx, show_scrollbar, thumb_index
end
